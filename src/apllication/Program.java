...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		 ...
		 * 
		 * nomeDaVariavel.substring(0,2)  -> significa que a string será 
		 * dividida em uma substring e guardada na variavel do comando 
		 * e os numero indicam a posição de onde será cortada (no caso
		 * da posição zero ao 2, se apenas colocar 3 serão selecionadas do 3 em diante*/
		System.out.println();
